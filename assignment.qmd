...
# This one took a bit of fanagaling, but in the end I had to go back and make a new data set that included the total_votes column and then made sure to group it by the precinct since there are multiple precincts in a county and we only want to see one. 
...
new_data %>%
  ...
  summarise(precincts = n(precinct_code))
...
How many precincts are there, and which county has the most? *There are 759 different precincts and ____ has the most precincts*
